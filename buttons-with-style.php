...
if( !defined( 'BWSWPOS_VERSION' ) ) {
	define( 'BWSWPOS_VERSION', '1.0.2' ); // Version of plugin
}
...
function bwswpos_shortcode( $atts, $content = null ) {
	...
	ob_start(); ?>
	  ...
	  <a href="<?php echo $button_link; ?>" class="<?php echo $button_main_class;  ?>" target="<?php echo $button_target; ?>" ><?php echo $button_name; ?></a>
